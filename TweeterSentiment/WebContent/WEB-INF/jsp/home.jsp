...
<html>
	<head>
		...
		<link href="css/bootstrap-edit.css" type="text/css" rel="stylesheet">
	</head>
	<body>
		<div class="jumbotron">
	      <div class="container" align="center">
	      	<h1>Twitter Sentimen Analyst Result</h1>
    <%
	...
	TwitterFactory tf;
	Twitter twitter;
	if((tf = new TwitterFactory(cb.build()))!=null){
		twitter = tf.getInstance();
		System.out.println("MASUK KE NONPROXY");
	}else{
		System.out.println("MASUK KE PROXY");
		cb.setDebugEnabled(true)
		  .setOAuthConsumerKey("LselEEvuLa2KbzGu03Bmg")
		  .setOAuthConsumerSecret("RVp4OXLfhsyC0iOpnuPxYXXyxxuTra8ISLtXwtbQJ4")
		  .setOAuthAccessToken("2219872879-0bi6R64rxhdIbUPSmeHgcIPh6oSZpSZw4t5mK0Q")
...
//                 	out.println("</p>");
            	...
            	for (int i = 0; i < neuTweets.size(); i++) {
            		System.out.println(neuTweets.size());
